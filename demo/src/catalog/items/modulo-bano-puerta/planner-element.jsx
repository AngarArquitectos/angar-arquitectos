...
import obj from "./3D_2.2.obj"; //modelo 3D .obj
import mtl from "./3D_2.2.mtl"; //archivo .mtl
import imagencrop from "./imagen.jpg"; //imagen de muestra
...
export default {
  name: "Modulo_baño_puerta",
  prototype: "items",

  info: {
    title: "Modulo Baño Puerta",
    price: "179.99",
    price1: "199.99",
    price2: "499.99",
    tag: ["furnishing"],
