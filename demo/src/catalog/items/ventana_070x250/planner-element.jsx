...
import obj from "./ventana_0.70_x_2.50.obj"; //modelo 3D .obj
import mtl from "./ventana_0.70_x_2.50.mtl"; //archivo .mtl
...
export default {
  name: "ventana_0.70_2.50",
  prototype: "items",

  info: {
    title: "Ventana 0,70x2,50",
    price: "179.99",
    price1: "199.99",
    price2: "499.99",
    tag: ["furnishing"],
  ...
  render2D: function (element, layer, scene) {
    ...
    return (
      <g transform={`translate(-${width / 2}, -${height / 2})`}>
        <rect x="0" y="0" width={width} height={height} style={style} />
      </g>
    );
  },
