...
import obj from "./Prueba.obj";
import mtl from "./modulo_espacio_80cm.mtl";
import imagen from "./80cm.jpg";
import imagencrop from "./80cm.jpg";
...
export default {
  name: "modulo_pasillo_80cm",
  prototype: "items",

  info: {
    title: "Modulo Pasillo 80",
    price: "149.99",
    price1: "5",
    tag: ["furnishing"],
    description: "modulo_pasillo_80cm",
    image: [imagen],
  },
