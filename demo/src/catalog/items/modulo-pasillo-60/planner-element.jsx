...
import obj from "./modulo_espacio_60cm.obj";
import mtl from "./modulo_espacio_60cm.mtl";
import imagen from "./60cm.jpg";
import imagencrop from "./60cm.jpg";
...
export default {
  name: "modulo_pasillo_60cm",
  prototype: "items",

  info: {
    title: "modulo_pasillo_60cm",
    price: "14900.99",
    price1: "19900.99",
    price2: "49900.99",
    tag: ["furnishing"],
    description: "modulo_pasillo_60cm",
    image: [imagen],
  },
  ...
  render3D: function (element, layer, scene) {
    ...
    let onLoadItem = (object) => {
      ...
      //importante
      object.position.x -= center[0] * 0.2;
      object.position.y -=
